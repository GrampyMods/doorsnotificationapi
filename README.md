...
_G.Notify("Item found", "You picked up the golden key", "item", 5)
_G.Notify("You died", "Caught by Figure", "error", 3)
_G.Notify("Escaped", "You survived the rush", "success", 4)
_G.Notify("Tip", "Stay in the light to avoid Shadow", "info", 4)
